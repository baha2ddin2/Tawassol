...
Route::middleware('jwt.cookie')->group(function () {
    ...
    Route::controller(NotificationController::class)->group(function () {
        ...
        Route::put('/mark-as-read/{notificationId}', 'markAsRead');
    ...
    Route::controller(FollowController::class)->group(function () {
        ...
        Route::get('/following/{userId}', 'getFollowingById');
        Route::get('/followers/{userId}', 'getFollowersById');
    ...
    Route::controller(MessageController::class)->group(function () {
        ...
        Route::get('/contact/{userId}', 'contact');
    ...
    Route::controller(GroupeController::class)->group(function () {
        ...
        Route::delete('/group/{groupId}','deleteGroup');
        Route::get('/group/available-members','getAvailableMembers');
        Route::post('/group/{groupId}','updateGroup');
        Route::get('/group/{groupId}', 'getGroupDetails');
        Route::delete('/group/{groupId}/member/{userId}', 'removeMember');
        Route::put('/group/{groupId}/make-admin/{userId}', 'makeAdmin');
    });
